    ...
    ***************************************************************************/
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (StdDraw.mousePressed() && !here) {
            	...
            	if (here) {
                    ...
                    double newY = StdDraw.mouseY() - 0.5;
                    double tg = (newY*x - newX*y) / (newY*y + newX*x);
                    if (tg != 0) {
        ...
        if (args.length == 1) {
            ...
            particles[n] = new Particle(0.5, 0.5, 0.0, 0.0, 0.1, 10.0, Color.RED);
            particles[n+1] = new Particle(0.5, 0.5, 0.0, 0.0, 0.01, 1.0, Color.GREEN);
        }
